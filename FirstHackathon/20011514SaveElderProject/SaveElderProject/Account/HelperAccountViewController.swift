...
class HelperAccountViewController: UIViewController {
    let accountFieldView = UIView()
    let elderInfoFieldView = UIView()
    let accountLabel = UILabel()
    let elderInfoLabel = UILabel()
    let userIDUpperLabel = UILabel()
    let userIDLabel = UILabel()
    var userEmail = ""
    let inviteCodeUpperLabel = UILabel()
    let inviteCodeLabel = UILabel()
    var inviteCode = ""
    let elderNameUpperLabel = UILabel()
    let elderNameLabel = UILabel()
    var elderName = ""
    let elderPhoneNumberUpperLabel = UILabel()
    let elderPhoneNumberLabel = UILabel()
