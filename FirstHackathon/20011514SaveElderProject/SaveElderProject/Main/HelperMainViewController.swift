...
class HelperMainViewController: UIViewController, CLLocationManagerDelegate {
    ...
    @objc private func didTapAccountButton() {
        ...
        let helperVC = HelperAccountViewController()
...
//            print(elderPhoneNumbers)
            ...
            helperVC.inviteCode = inviteCode
            helperVC.elderName = elderNames
            helperVC.elderPhoneNumber = elderPhoneNumbers
            helperVC.userEmail = email
